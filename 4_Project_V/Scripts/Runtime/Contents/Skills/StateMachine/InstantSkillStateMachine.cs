...
public class InstantSkillStateMachine : StateMachine<Skill>
{
    ...
    protected override void MakeTransitions()
    {
        ...
        (state as ChargingState).IsChargeSucceed && Owner.HasPrecedingAction);
        MakeTransition<ChargingState, InActionState>(state => (state as ChargingState).IsChargeSucceed);
