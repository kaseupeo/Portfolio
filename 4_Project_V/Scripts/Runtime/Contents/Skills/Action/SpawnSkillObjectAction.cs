...
public class SpawnSkillObjectAction : SkillAction
{
    ...
    [Header("TargetPlayer Searcher")]
    [SerializeField] private TargetSearcher targetSearcherForSkillObject;
    ...
    public override void Apply(Skill skill)
    {
        ...
        {
            var skillObject = Managers.Resource.Instantiate(skillObjectPrefab, pooling: true).GetComponent<SkillObject>();
            ...
            skillObject.Init(skill, targetSearcherForSkillObject, duration, applyCount, objectScale);
        }
    }
