...
namespace MyCustomEditor
{
    ...
    public class SkillTreeSlotNodeEditor : NodeEditor
    {
        ...
        private Dictionary<string, bool> _isFoldoutExpandedByNameDic = new Dictionary<string, bool>();
        ...
        public override void OnHeaderGUI()
        {
            ...
            string header = $"Tier {targetAsSlotNode.Tier} - {targetAsSlotNode.Index} / " +
                            (targetAsSlotNode.Skill?.CodeName ?? target.name);
        ...
        {
            list.drawHeaderCallback = rect => { EditorGUI.LabelField(rect, "Preceding Skills"); };
        ...
        private bool DrawFoldoutTitle(string title)
            => CustomEditorUtility.DrawFoldoutTitle(_isFoldoutExpandedByNameDic, title);
    }
}